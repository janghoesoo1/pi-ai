...
| bf/workspace | `~/bf/workspace` | Kotlin DDD 백엔드(api/common/domain-ai·employee·mail·timesheet) + React/Vite 프론트 + Jenkins/GitLab CI, 운영 HR SaaS(제품이 Claude 사용) | 운영/회사 → 읽기·제안만, 자동머지·프로덕션 쓰기 금지 | **구조 파악 완료, 보수적 AGENTS.md 초안 제시(미적용)** |
